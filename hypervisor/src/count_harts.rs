...
// Mock device tree from qemu-rustsbi example
// Based on https://github.com/rustsbi/rustsbi-qemu/blob/main/rustsbi-qemu/src/count_harts.rs

const DEVICE_TREE_MAGIC: u32 = 0xD00DFEED;

lazy_static::lazy_static! {
    // Maximum hardware thread number; only write at startup, read when cross-core softirq occurs
